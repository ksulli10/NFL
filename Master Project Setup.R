...
# create rosters data frames
source("Workspace/Generate Rosters Data Frames.R")

# save rosters data frames into local RDS files
source("Workspace/Save Rosters as RDS.R")