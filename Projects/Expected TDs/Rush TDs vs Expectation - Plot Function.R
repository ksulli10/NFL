  ...
  ggplot(data = rush_td_data,
    ...
    labs(
      ...
      title = paste("Touchdowns over Expectation (",
                    ...
                    ")",
                    sep = ""),
      subtitle = paste("Min.", attempts, "Rush Attempts"),
