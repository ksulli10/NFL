...
clean_rush_td_vs_expected <- function(season) {
  ...
  # run get_rush_td_vs_expected function on pbp_input string formed above
  output <- get_rush_td_vs_expected(season)
  ...
  # remove duplicates
  output <- output[!duplicated(output$rusher_player_id), ]
